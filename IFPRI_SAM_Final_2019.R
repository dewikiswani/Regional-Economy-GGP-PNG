...
write_xlsx(
  x = list("PNG_2019_IO" = io_table_export),
  path = "PNG_2019_IO_Table.xlsx",
  col_names = TRUE,
  format_headers = TRUE
)

cat("Successfully exported 'PNG_2019_IO_Table.xlsx' with 6 decimal places.\n")
...
write_xlsx(
  x = list("Oro_2019_IO" = oro_io_export),
  path = "Oro_2019_IO_Table.xlsx",
  col_names = TRUE,
  format_headers = TRUE
)

cat("Successfully exported 'Oro_2019_IO_Table.xlsx' with 6 decimal places.\n")
